sap.ui.define([
     ...
     */
    function (Controller, Filter, FilterOperator, MessageBox, BusyIndicator, library) {
      "use strict";
      let CController;
      let goThat;
      let giSearch;
  
      CController = Controller.extend("zalcsa.aprobacionnotasv2.controller.Master", {
        /**
         * Called when a controller is instantiated and its View controls (if available) are already created.
         * Can be used to modify the View before it is displayed, to bind event handlers and do other one-time initialization.
         * @memberOf zalcsa.aprobacionnotasv2.view.Master
         */
        onInit: function () {
        ...
        _onStartInitialDialog: function () {
          ...
          if (!goThat._ofrgInitial) {
            goThat._ofrgInitial = sap.ui.xmlfragment(
              "idFragment1",
              "zalcsa.aprobacionnotasv2" + ".view.dialog.InitialInput",
              goThat
            );
        ...
        onHelpBukrs: function (oEvent) {
          let sInputValue = oEvent.getSource().getValue();
            ...
            this._ofrgHelpBukrs = sap.ui.xmlfragment(
              "idFragment3",
              "zalcsa.aprobacionnotasv2" + ".view.dialog.valueHelp_bukrs",
              this
            );
        ...
        onHelpKunnr: function (oEvent) {
          let sInputValue = oEvent.getSource().getValue();
            ...
            this._ofrgHelpKunnr = sap.ui.xmlfragment(
              "idFragment4",
              "zalcsa.aprobacionnotasv2" + ".view.dialog.valueHelp_kunnr",
              this
            );

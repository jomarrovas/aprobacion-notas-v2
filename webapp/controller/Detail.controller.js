sap.ui.define([
    ...
    "zalcsa/aprobacionnotasv2/service/Solicitud"
],
    /**
    ...
    function (Controller, 
        ...
        CController = Controller.extend("zalcsa.aprobacionnotasv2.controller.Detail", {
      /**
       * Called when a controller is instantiated and its View controls (if available) are already created.
       * Can be used to modify the View before it is displayed, to bind event handlers and do other one-time initialization.
       * @memberOf zalcsa.aprobacionnotasv2.view.Detail
       */
            onInit: function () {
        ...
        oRows.filter(aFilters);
          ...
          this._ofrgHelp = sap.ui.xmlfragment(
            "idFragment2",
            "zalcsa.aprobacionnotasv2" + ".view.dialog.valueHelp",
            this
          );
...
//                        }
                        let oSelCobranza = this.getOwnerComponent().getSelCobranza();
                        let oTable = this.getView().byId("idTable2");
                        // let oDetCobranza = oTable.getRows()[1].getBindingContext().getObject();
                        ...
                        let mAprove = {
                            ...
                            //Anio: oDetCobranza.Anio,
                            //CpagoActual: oSelCobranza.CpagoActual,
                            //CpagoNuevo: oSelCobranza.CpagoNuevo,
                            //Aprobar: true
                        };
        ...
        oSetInterval = setInterval(fnSetInterval, 1000);
            ...
            /**
             *@memberOf zalcsa.aprobacionnotasv2.view.Main

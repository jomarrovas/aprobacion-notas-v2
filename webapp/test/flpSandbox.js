		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Aprobación de Notas de Crédito",
									"targetURL": "#zalcsaaprobacionnotas-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zalcsaaprobacionnotas-display": {
								"semanticObject": "zalcsaaprobacionnotas",
								"action": "display",
								"description": "Aprobación de Notas de Crédito",
								"title": "Aprobación de Notas de Crédito",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zalcsa.aprobacionnotas",
									"url": sap.ui.require.toUrl("zalcsa/aprobacionnotas")
								}
							}
						}
					}
